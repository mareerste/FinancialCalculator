...
const AddExpenseComponent = ({ onSubmitExpense }) => {
  ...
  const [error, setError] = useState({ datum: false });
  /*
  {
  "dateTime": "2023-09-14T12:41:22.363Z",
  "description": "Groceries",
  "categoryId": "b58ceeb8-551d-4fad-80f5-08db9aa71a20",
  "value": 450,
  "username": "marko123"
}
  */
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          {errors.datum && (
            <Alert
              variant="danger"
              onClose={() => setError({ datum: false })}
              dismissible
            >
              <p className="fs-5">
                Morate uneti datum (datum rocista mora biti najmanje 7 dana
                posle trenutka zakazivanja)
              </p>
            </Alert>
          )}
